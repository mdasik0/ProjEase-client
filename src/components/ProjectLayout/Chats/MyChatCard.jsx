          ...
          <div className="message-actions-container relative">
            ...
            <div className="replyandActions opacity-0 group-hover:opacity-100 duration-300">
              <button
                ...
                className="bg-gray-200 p-2 rounded-full active:scale-95 hover:bg-gray-300 duration-300 tooltip absolute top-[50%] -translate-y-[50%] -left-[40px]"
                data-tip="reply"
              >
