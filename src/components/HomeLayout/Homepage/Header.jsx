...
const Header = () => {
  return (
    <header className="flex justify-between items-center md:flex-row flex-col-reverse max-w-[90vw] mx-auto md:mt-10 md:gap-10 gap-6">
      <div className=" lg:w-[500px] md:text-start text-center">
        ...
        <p className=" lg:my-6 md:my-4 mt-2 mb-6 text-sm text-gray-600 ">ProjEase lets you manage all your projects in one place. With built-in tasks, chat, and video calls, there’s no need to switch between tools.</p>
