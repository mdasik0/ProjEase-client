...
const FailedToLoadDataCard = () => {
    return (
        <div className="task_cards bg-red-400 text-white flex flex-col gap-4 items-center justify-center text-center p-5 mt-3 h-[174px] pt-3 px-2 rounded-xl cursor-pointer">
